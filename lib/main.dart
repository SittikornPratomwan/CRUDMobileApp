...
class _homeState extends State<home> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: StreamBuilder(
          stream: universityCollection.snapshots(),
                  ...
                  itemBuilder: ((context, index) {
                    ...
                    return Slidable(
                      ...
                      endActionPane:
                          ...
                          onPressed: (context) {
                            Navigator.push(
                                ...
                                MaterialPageRoute(
                                    ...
                                    settings:
                                        RouteSettings(arguments: postIndex)));
                          },
                        ...
                        SlidableAction(
                          onPressed: (context) {
                            universityCollection.doc(postIndex.id).delete();
                          },
                      ...
                      child: ListTile(
                        title: Text(postIndex['university']),
                        subtitle: Text(postIndex['ranking']),
                      ),
                    );
                  }));
            } else {
